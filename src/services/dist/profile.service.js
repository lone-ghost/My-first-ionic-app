...
var ProfileService = /** @class */ (function () {
    ...
    ProfileService.prototype.updateName = function (fullName) {
        return this.userProfile.update({ fullName: fullName });
    };
    ProfileService.prototype.updateEmail = function (newEmail, password) {
        return __awaiter(this, void 0, Promise, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        credential = firebase["default"].auth.EmailAuthProvider.credential(this.currentUser.email, password);
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 4, , 5]);
    ...
    ProfileService.prototype.updatePassword = function (newPassword, oldPassword) {
        return __awaiter(this, void 0, Promise, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        credential = firebase["default"].auth.EmailAuthProvider.credential(this.currentUser.email, oldPassword);
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, this.currentUser.reauthenticateWithCredential(credential)];
